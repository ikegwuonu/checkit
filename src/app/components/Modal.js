              ...
              {() => (
                <Form className="mt-4">
                  ...
                  <div className="mt-4 sm:flex sm:items-center sm:-mx-2">
                    <button
                      type="submit"
                      className="w-full px-4 py-2 mt-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-600 rounded-md hover:bg-gray-300 focus:outline-none focus:ring focus:ring-gray-400"
                    >
                      Submit
                    </button>
                  </div>
